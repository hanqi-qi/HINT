...
for bin in [0,1,2,3,4]:
    f0 = pd.read_csv("/home/hanq1yanwarwick/SINE/eraser_metric/output_logits/VMASK/prediction_results_original_999bin.csv",index_col="idx")
    f1 = pd.read_csv("/home/hanq1yanwarwick/SINE/eraser_metric/output_logits/VMASK/prediction_results_{}_{}bin.csv".format(metric,bin),index_col="idx")
